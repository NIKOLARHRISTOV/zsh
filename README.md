...
-   A Unix-like operating system: macOS, Linux, BSD. On Windows: WSL2 is
    preferred, but cygwin or msys also mostly work.
...
The default location is `~/ZSH` (hidden in your home directory, you can access
it with `cd ~/ZSH`)
...
The install script also accepts these variables to allow installation of a
...
[Ruby on Rails development agency](http://www.planetargon.com/services/ruby-on-rails-development?utm_source=github).
Check out our
